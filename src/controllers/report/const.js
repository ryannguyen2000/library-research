...
const OTAS_ICON = {
	...
	cozrum: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 202.5 202.5"><circle cx="101.23" cy="101.23" r="101.23" fill="#0bb3c8"/><g fill="#fff"><path d="M131.85 96.26a31.08 31.08 0 1 1 0-17.87l20.15-4.1a51.57 51.57 0 1 0-89.51 46l39.65 46.4 39.55-46.4a51.55 51.55 0 0 0 10.32-20z"/><circle cx="102.09" cy="87.32" r="15.49"/></g></svg>`,
